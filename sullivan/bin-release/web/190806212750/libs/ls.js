var shareObj = {
	...
	imgUrl: "http://als.ha0y.cn/sullivan/resource/assets/share.png",
	copy: "莎莉文中秋献礼"
};
...
var initWx = function () {
	if (wx && wxConfig) {
		...
		wx.config({
			...
			jsApiList: ["onMenuShareTimeline","onMenuShareAppMessage", "addCard", "closeWindow", "hideMenuItems", "showMenuItems"]
		});
