...
var Message = (function (_super) {
    ...
    function Message() {
        ...
        _this.txtStr.stroke = 1;
        _this.txtStr.strokeColor = 0xffffff;
    ...
    Message.prototype.show = function (str) {
        ...
        this.y = StageUtils.CH - 100;
        this.alpha = 1;
        egret.Tween.get(this).wait(3000).to({ y: this.y - 100, alpha: 0 }, 1000, egret.Ease.quadIn).call(this.tweenEnd, this);
    };
